...
urlpatterns = [
    ...
    path('<str:controllerName>/barcode/<str:barcode>', base_controller.detail, name='base_controller_by_barcode'),
    path('<str:controllerName>/id/<int:id>', base_controller.detail_id, name='base_controller_by_id'),
